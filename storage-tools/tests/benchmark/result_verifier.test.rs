...
use poker_hands_storage_tools::benchmark::hot::result_verifier::verify_benchmark_results;
use poker_hands_storage_tools::benchmark::types::HandBenchmarkItem;
...
fn result_verifier_matches_source_and_binary_action_counts() {
    ...
    let service = StoreQueryService::open(&output_path, 3, true).unwrap();
