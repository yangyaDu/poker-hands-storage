...
use super::types::{BenchmarkCommand, BenchmarkCompareCommand, BenchmarkSqliteCommand};
...
pub fn parse_benchmark_sqlite_args(args: Vec<String>) -> Result<BenchmarkSqliteCommand, ToolError> {
    let mut source = None;
