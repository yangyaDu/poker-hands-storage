...
- [x] **Step 9: Commit core contract changes**
...
- [x] **Step 8: Commit service contract changes**
...
- [x] **Step 5: Commit native Rust contract changes**
...
- [x] **Step 7: Commit JS SDK contract changes**
...
**Status:** Implementation merged into `codex/task1-core-query-contract` branch commit `2731b53`.

- [x] **Step 1: Update HTTP consistency test**
...
- [x] **Step 2: Run HTTP consistency when service URL is available**
...
- [x] **Step 5: Update remaining docs references**
...
- [x] **Step 7: Commit docs and consistency changes**
