...
use crate::builder::{discover_dimensions, DimensionSpec};
use crate::error::AppError;
use crate::hand_dict::get_hand_id;
use crate::manifest::{load_manifest, BuildManifest};
use crate::meta_db::MetadataReader;
use crate::naming::{get_bin_file_name, get_idx_file_name, quote_identifier};
use crate::sqlite::{Connection, Value};
use crate::verifier::precision::{
...
use crate::verifier::standalone::{run_standalone_verify, StandaloneVerifyOptions};
    ...
    if !frequency_check.ok {
        ...
        push_source_failure(
            ...
            format!(
                ...
                cell.frequency,
                crate::verifier::precision::format_float32_bits(frequency_check.expected_bits),
                crate::verifier::precision::format_float32_bits(frequency_check.actual_bits)
            ),
            context,
        );
        return true;
